   ...
   for roi in rois:
      ...
      for exp in exps:  
         ...
         for comb in combs:
            ...
            draw.text((800/2, 30), "SAR First", (0,0,0), font = font, anchor ='mt')
            draw.text((3*800/2, 30), "SAR Last", (0,0,0), font = font, anchor ='mt')
...
for site_code in st.session_state['sites']:
   ...
   st.title(site_name)
   exp_codes =  [103, 106] #, 105, 106, 107, 202, 203, 205, 206, 301, 302, 303, 306, 311, 312, 313, 316, 401, 402, 403, 411, 412, 413]
   exp_codes += [153, 156] #, 155, 156, 157, 252, 253, 255, 256, 351, 352, 353, 356, 361, 362, 363, 366, 451, 452, 453, 461, 462, 463]
