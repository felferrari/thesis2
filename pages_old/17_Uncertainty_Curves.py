...
def plot_uncertainty_graphic(results, metric, metric_header, site_code):
   ...
   fig.suptitle(f"{uncertainty_results['full_name'][0]} Site {site_code[1]}")
...
for site_code in st.session_state['sites']:
   ...
   for exp_code in st.session_state['experiments'] :
      ...
      plot_uncertainty_graphic(results, 'f1score', 'F1-Score', site_code)
