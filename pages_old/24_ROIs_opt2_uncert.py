   ...
   for roi in rois:
      ...
      for exp in exps:  
         ...
         for comb in combs:
            ...
            img_name = f"entropy_{site_name}-{experiments[exp]['name']}-{comb.split('_')[1]}_roi_{roi.split('_')[1]}"
            ...
            img_name = f"error_{site_name}-{experiments[exp]['name']}-{comb.split('_')[1]}_roi_{roi.split('_')[1]}"
            ...
            draw.text((5*800/2, 30), "Uncertainty", (0,0,0), font = font, anchor ='mt')
